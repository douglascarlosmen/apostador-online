...
<head>
  <meta charset="utf-8">
    ...
    <link rel="icon" href="{{ asset('/powerbi_vertical/images/favicon.ico') }}">

    <title>Aplicação</title>

	<!-- Vendors Style-->
	<link rel="stylesheet" href="{{ asset('/powerbi_vertical/css/vendors_css.css') }}">

	<!-- Style-->
	<link rel="stylesheet" href="{{ asset('/powerbi_vertical/css/style.css') }}">
	<link rel="stylesheet" href="{{ asset('/powerbi_vertical/css/skin_color.css') }}">
...
<div class="wrapper">
  ...
  <header class="main-header">
	<div class="d-flex align-items-center logo-box justify-content-start">
		...
		<a href="index.html" class="logo justify-content-around">
		  <!-- logo-->
		  <div class="logo-lg">
			  <span class="light-logo"><img src="{{ asset('/powerbi_vertical/images/logo-light-text.png') }}" alt="logo"></span>
			  <span class="dark-logo"><img src="{{ asset('/powerbi_vertical/images/logo-light-text.png') }}" alt="logo"></span>
		  </div>
		</a>
	</div>
    <!-- Header Navbar -->
  ...
  @include('application.template.sidemenu')
          ...
          <div class="media-list media-list-hover mt-20">
			<div class="media py-10 px-0">
			  <a class="avatar avatar-lg status-success" href="#">
				<img src="{{ asset('/powerbi_vertical/images/avatar/1.jpg') }}" alt="...">
			  </a>
			...
			<div class="media py-10 px-0">
			  <a class="avatar avatar-lg status-danger" href="#">
				<img src="{{ asset('/powerbi_vertical/images/avatar/2.jpg') }}" alt="...">
			  </a>
			  <div class="media-body">
				<p class="fs-16">
			...
			<div class="media py-10 px-0">
			  <a class="avatar avatar-lg status-warning" href="#">
				<img src="{{ asset('/powerbi_vertical/images/avatar/3.jpg') }}" alt="...">
			  </a>
			  <div class="media-body">
				<p class="fs-16">
			...
			<div class="media py-10 px-0">
			  <a class="avatar avatar-lg status-primary" href="#">
				<img src="{{ asset('/powerbi_vertical/images/avatar/4.jpg') }}" alt="...">
			  </a>
			  <div class="media-body">
				<p class="fs-16">
				  <a class="hover-primary" href="#"><strong>Evan</strong></a>
...
<!-- ./wrapper -->
                ...
                <div class="chat-logs">
                    <div class="chat-msg user">
                        <div class="d-flex align-items-center">
                            <span class="msg-avatar">
                                <img src="{{ asset('/powerbi_vertical/images/avatar/2.jpg') }}" class="avatar avatar-lg">
                            </span>
                            <div class="mx-10">
                    ...
                    <div class="chat-msg self">
                        <div class="d-flex align-items-center justify-content-end">
                            ...
                            <span class="msg-avatar">
                                <img src="{{ asset('/powerbi_vertical/images/avatar/3.jpg') }}" class="avatar avatar-lg">
                            </span>
                        </div>
                        <div class="cm-msg-text">
	...
	<!-- Vendor JS -->
	<script src="{{ asset('/powerbi_vertical/js/vendors.min.js') }}"></script>
	<script src="{{ asset('/powerbi_vertical/js/pages/chat-popup.js') }}"></script>
    <script src="{{ asset('/powerbi_vertical/assets/icons/feather-icons/feather.min.js') }}"></script>

	<!-- Power BI Admin App -->
	<script src="{{ asset('/powerbi_vertical/js/template.js') }}"></script>
