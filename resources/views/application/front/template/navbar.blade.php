                ...
                <div class="col-12">
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item dropdown p-1">
                            <a class="nav-link dropdown-toggle btn lotofacil" href="#" role="button" data-toggle="dropdown"
                                aria-expanded="false">
                                Lotofácil
                            </a>
                        ...
                        <li class="nav-item dropdown p-1">
                            <a class="nav-link dropdown-toggle btn quina" href="#" role="button" data-toggle="dropdown"
                                aria-expanded="false">
                                Quina
                            </a>
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <li class="nav-item dropdown p-1">
                            <a class="nav-link dropdown-toggle btn dupla" href="#" role="button" data-toggle="dropdown"
                                aria-expanded="false">
                                Dupla-Sena
                            </a>
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <li class="nav-item dropdown p-1">
                            <a class="nav-link dropdown-toggle btn dia" href="#" role="button" data-toggle="dropdown"
                                aria-expanded="false">
                                Dia de Sorte
                            </a>
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
