    ...
    <section class="sidebar position-relative">
		<div class="user-profile px-20 py-15">
			<div class="d-flex align-items-center">
				<div class="image">
				  <img src="{{ asset('/powerbi_vertical/images/avatar/avatar-13.png') }}" class="avatar avatar-lg bg-primary-light" alt="User Image">
				</div>
				<div class="info">
			...
			<ul class="list-inline profile-setting mt-30 mb-20 d-flex justify-content-between">
				...
				<li><a href="#" data-bs-toggle="tooltip" data-bs-placement="top" title="Logout"><i data-feather="log-out"></i></a></li>
			</ul>
        </div>
	  	<div class="multinav">
